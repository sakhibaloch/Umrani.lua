...
local Passwords = {"MrSin20D","ull","ull","ull"} 
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_OTHER)
gg.searchNumber("134,914;133,890", gg.TYPE_DWORD)                                                                                                                                                                                                                                                                                                                                                                                                                                                --@Maded by @probolte--
...
gg.alert("BYPASS V3 ( @UMRANICHANNELS ) ...")
  gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(":abnormal", gg.TYPE_BYTE)
  gg.getResults(999999)
  gg.editAll(";", gg.TYPE_WORD)
  gg.clearResults()
  gg.setVisible(false)
  gg.searchNumber(";abnormal", gg.TYPE_WORD)
  gg.getResults(999999)
  gg.editAll(";", gg.TYPE_WORD)
  gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(":Network error", gg.TYPE_BYTE)
  gg.getResults(99999)
  gg.editAll(";", gg.TYPE_WORD)
  gg.clearResults()
  gg.clearResults()
  ...
  gg.searchNumber("2,019,778,399;1,768,055,141;1,700,880,223;1,969,187,170;1,701,147,238;1,953,718,111;1,701,011,826;1,751,347,809:512", gg.TYPE_DWORD)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("-1", gg.TYPE_DWORD)
  gg.setVisible(false)
  gg.clearResults()
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("1,685,382,481;1,685,382,482;3,510,224;1,735,356,001;1,769,497,972;1,752,397,164;1,232,233,843:4869", gg.TYPE_DWORD)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("-1", gg.TYPE_DWORD)
  gg.setVisible(false)
  gg.clearResults()
  gg.loadList("/storage/emulated/0/[###].data", gg.LOAD_APPEND)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("-1", gg.TYPE_DWORD)
  gg.clearResults()
  ...
  gg.searchNumber(";AntiCheat", gg.TYPE_WORD, false, gg.SIGN_EQUAL, 3201970176, 3297357823, 0)
  ...
  gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll(";DelReport", gg.TYPE_WORD)
  gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(":abnormal", gg.TYPE_BYTE)
  ...
  gg.clearResults()
  gg.setVisible(false)
  gg.loadList("/storage/emulated/0/[###].dat", gg.LOAD_APPEND)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.clearResults()
  gg.loadList("/storage/emulated/0/[###].dat", gg.LOAD_APPEND)
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(":terminated", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("0", gg.TYPE_BYTE)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_CODE_APP)
  gg.clearResults()
  gg.setVisible(false)
  gg.searchNumber(":connection", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("0", gg.TYPE_BYTE)
  gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(";Failed to join match. The game is over", gg.TYPE_WORD, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
  ...
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(":Your game environment is abnormal,check your game environment.", gg.TYPE_BYTE)
  gg.getResults(999999, nil, nil, nil, nil, nil, nil, nil)
  gg.getResults(999999, nil, nil, nil, nil, nil, nil, nil)
  gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  gg.searchNumber(";Your game environment is abnormal,check your game environment.", gg.TYPE_WORD)
  gg.getResults(999999, nil, nil, nil, nil, nil, nil, nil)
  gg.getResults(999999, nil, nil, nil, nil, nil, nil, nil)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_ANONYMOUS | gg.REGION_CODE_APP)
  ...
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_DATA | gg.REGION_CODE_APP)
  gg.searchNumber(":GetReportData", gg.TYPE_BYTE)
  gg.getResults(100000)
  gg.editAll("0", gg.TYPE_BYTE)
  gg.clearResults()
  gg.setVisible(false)
  gg.setRanges(gg.REGION_C_DATA | gg.REGION_CODE_APP)
  gg.searchNumber(":DelReportData", gg.TYPE_BYTE)
  gg.getResults(100000)
  gg.editAll("0", gg.TYPE_BYTE)
  gg.setVisible(false)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_DATA | gg.REGION_CODE_APP)
  gg.searchNumber(":enable_report", gg.TYPE_BYTE)
  gg.getResults(100000)
  gg.editAll("0", gg.TYPE_BYTE)
  gg.clearResults()
  gg.setVisible(false)
  ...
  gg.setVisible(false)
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber(":tss_enable_get_report_data", gg.TYPE_BYTE)
  gg.getResults(100000)
  gg.editAll("0", gg.TYPE_BYTE)
  gg.clearResults()
gg.alert("BYPASS V3 ( @UMRANICHANNELS ) ✓")
